  ...
  methods: {
    ...
    async loadInfo() {
      ...
      try {
        ...
        this.followerCnt =
          response.data.followers != null ? response.data.followers.length : 0;
        this.followingCnt =
          response.data.following != null ? response.data.following.length : 0;
        this.postCnt =
          response.data.posts != null ? response.data.posts.length : 0;
        this.followStatus =
          response.data.followers != null
      ...
      <div class="container-fluid mt-3">
        <div class="row ">
          <div class="col-12 d-flex justify-content-center">
            ...
            <label v-if="sameUser" class="btn my-btn-add-photo ms-2 d-flex align item center" for="fileUploader">Add</label> 
          </div>
        </div>
